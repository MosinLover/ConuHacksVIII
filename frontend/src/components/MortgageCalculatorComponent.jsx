...
const MortgageCalculatorComponent = ( {setMonthlyPayment, setPrincipalWithInflationData, setPrincipalData, setMortgageAmount, setAmortizationYears, setAmortizationMonths, setPaymentFrequency, setInterestRate, setInterestType, setInterestTermYears, setInterestTermMonths, monthlyPayment, mortgageAmount, amortizationYears, amortizationMonths, paymentFrequency, interestRate, interestType, interestTermYears, interestTermMonths} ) => {
  ...
  const handleCalculate = () => {
    ...
    for (let i = 0; i < freq * parseInt(amortizationYears, 10); i++) {
      ...
      let interestPayment = presentValue * (1 + nominalInterestRate);
